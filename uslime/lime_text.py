...
class USLimeTextExplainer(LimeTextExplainer):
    def __init__(self, kernel_width=25, kernel=None, verbose=False, class_names=None, feature_selection='auto', split_expression=r'\W+', bow=True, mask_string=None, random_state=None, char_level=False):
        super(USLimeTextExplainer, self).__init__(kernel_width, kernel, verbose, class_names, feature_selection, split_expression, bow, mask_string, random_state, char_level)
        ...
        for label in labels:
            (ret_exp.intercept[label],
             ...
             # ------------------------------ 
                ...
                last_filtered_data, filtered_yss, distances, label, num_features,
                model_regressor=model_regressor,
                feature_selection=self.feature_selection,
